...
char confetti_get_greater(const char what1, const char what2) { if (what1>what2) return what1; else return what2; }

char confetti_get_lesser(const char what1, const char what2) { if (what1<what2) return what1; else return what2; }
